...
describe('Test for detecting obstacles and stopping', function () {
    it('should detect an obsacle and stop a coordinate before it ', function () {
        let rover = new Rover(0, 0, "EAST");
        rover.setObstacles([[3,5],[4,3]])
        rover.moveRover("FFFLFFFFF")
        expect(rover.currentXPos).equal(3);
        expect(rover.currentDirection).equal("NORTH");
    });
});
